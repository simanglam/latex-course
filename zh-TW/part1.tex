...
\tiny{圖片授權：\href{https://pixabay.com/en/animal-apple-attractive-beautiful-1239390/}{CC0}}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{使用之前}
...
\item 所有的文件開頭都是\cmdbs{documentclass}
\item \emph{必選參數}被花括號包圍\keystrokebftt{\{} \keystrokebftt{\}}告訴 \LaTeX{}我們想要的文件類型是\bftt{article}.
\item 百分符號\keystrokebftt{\%}開始註解 --- \LaTeX{}會忽略該行剩餘的部分
\end{itemize}
\end{frame}
...
\item 大多數的時間就和Word無異，不用多想的將內容打進文件%怪怪的，要修
